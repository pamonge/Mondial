...
const casaAlgezares = {
    ...
    caracteristicasBasicas: {
        metrosCuadradosConstruidos: 180,
        dormitorios: 5,
        banos: 1,
        terrazas: 1,
    ...
    ubicacion: {
        direccion: "Calle de las Rocas 5, Algezares, Pedanías Este, Murcia",
        planta: "Bajo",
        barrio: "Algezares",
    ...
    tipoPropiedad: "Casa",
    tieneVistas: true,
    descripcionVistas: "Vistas increíbles y panorámicas a la huerta, la ciudad de Murcia y el majestuoso Santuario de la Fuensanta",
    necesitaReformaIntegral: true,
    zonaBarbacoa: true,
