...
Datos profesionales (los incluidos en los CVs)
...
Por favor, tenga en cuenta que, si decide no facilitarnos esos datos, es posible que no pueda completar su registro como usuario o que no pueda disfrutar de esos servicios o funcionalidades.</p>
<h3>¿CON QUÉ FINALIDAD TRATAMOS SUS DATOS PERSONALES?</h3>

<p>Dependiendo de cómo interactúe con nuestra web, trataremos sus datos personales para las
...
2. Para formar parte en los procesos de selección.

Trataremos los datos personales que nos proporcione a través de su CV, a fin de gestionar las candidaturas para los puestos de trabajo ofrecidos.

3. Análisis de usabilidad y de calidad para la mejora de nuestros servicios (Cookies)
...
La base legítima para tratar sus datos con finalidades de selección de personal, es su consentimiento.

3. Análisis de usabilidad y de calidad (Cookies)
</p>
...
Trataremos sus datos durante el tiempo que sea necesario para evaluar su candidatura y posteriormente dos años para que opte a futuros puestos de trabajo.
</p>
<h3>¿COMPARTIREMOS SUS DATOS CON TERCEROS?</h3>
<p>
...
Para llevar a cabo la prestación del servicio correspondiente y poner en contacto a los solicitantes con ofertantes de servicios.
...
Podrá ejercitarlos sin coste alguno remitiéndonos un correo electrónico a nuestra dirección info@abadgrupoinmobiliario.es, simplemente indicándonos el motivo de su solicitud y el derecho que quiere ejercitar.
