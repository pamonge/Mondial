...
export const CookiesPage = () => {
  return (
    <div className='flex flex-col gap-3 text-justify p-5'>
      ...
      <p>Esta política de cookies fue actualizada por última vez el 28 de febrero de 2025 y se aplica a los ciudadanos y residentes legales permanentes del Espacio Económico Europeo y Suiza.</p>

<h3>1. Introducción</h3>
<p>Nuestra web, https://abadgrupoinmobiliario.es (en adelante: «la web») utiliza cookies y otras tecnologías relacionadas (para mayor comodidad, todas las tecnologías se denominan «cookies»). Las cookies también son colocadas por terceros a los que hemos contratado. En el siguiente documento te informamos sobre el uso de cookies en nuestra web.</p>
...
<h3>5.2 Cookies de marketing/seguimiento</h3>
...
<p>Por favor lea la política de privacidad de estas redes sociales (que puede cambiar frecuentemente) para saber que hacen con sus datos (personales) que procesan usando estas cookies. Los datos que reciben son anonimizados lo máximo posible. Instagram está ubicado en los Estados Unidos.</p>

<h3>Consent to service varios</h3>
...
<h3>Tienes los siguientes derechos con respecto a tus datos personales:</h3>

<p>Tiene derecho a saber por qué se necesitan tus datos personales, qué sucederá con ellos y durante cuánto tiempo se conservarán.
...
ABAD SERVICIOS INMOBILIARIOS S.L.
C/ Fernández Caballero, 1 Bajo, 30001, Murcia
España
Web: https://abadgrupoinmobiliario.es
Correo electrónico: info@abadgrupoinmobiliario.es

Esta política de cookies se ha sincronizado con cookiedatabase.org el 28 de febrero de 2025.
    </div>
  )
}
