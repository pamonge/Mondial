...
export const SocialMediaComponent = () => {
  ...
  return (
    <div className='flex text-[#141230] gap-10 h-full items-center p-8 max-sm:flex-col'>
      ...
      <div className='flex flex-col justify-evenly min-md:w-1/2 h-full min-md:min-h-[30vh]' >
        ...
        <a href={`mailto:${dataMondial.email}`} className='flex items-center gap-3 ' >
          <img className='min-md:w-10 max-sm:w-7 max-sm:text-base' src={iconMail} alt="Correo" /> {dataMondial.email}
        </a>
      </div>
