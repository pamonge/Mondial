...
const AboutUsStyles = {
    ...
    gridCols:'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-11/12 mx-auto ',
    image: 'w-11/12   object-cover rounded-2xl shadow-md mx-auto my-8',
    
    conclution: `gap-2 font-poppins text-base text-center p-5 w-11/12 mx-auto text-white bg-[${conclutionColor}] rounded-2xl shadow-md mt-2`,
};
