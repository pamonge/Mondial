const navBarStyles = {
    navBarContainer : 'p-2 bg-blue-900 flex justify-between align-middle items-center text-white',
    ...
    hamburgerButton: 'lg:hidden flex flex-col w-8 h-8 justify-center items-center space-y-1.5 z-500',
