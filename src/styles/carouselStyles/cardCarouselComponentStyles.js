const cardCarouselStyles = {
    cardContainer: 'h-full w-[98%] flex-shrink-0 cursor-pointer   rounded-2xl   ', 
    imgContainer: 'rounded-2xl overflow-hidden mb-4 sm:mb-6 relative h-[35vh] h-[400px] md:h-[500px]',
